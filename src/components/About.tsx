...
export default function About() {
    return (
        <section id="about-section-z3k8v5m9" className="relative py-24 md:py-32 bg-zinc-900 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16">
                ...
                >
                    <h2 className="font-display text-4xl md:text-5xl font-thin uppercase text-white mb-8">
                        Forge Your <br />
                        <span className="italic bg-linear-to-r from-indigo-400 to-indigo-200 bg-clip-text text-transparent">Legacy</span>
                    </h2>
